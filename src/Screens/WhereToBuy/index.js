...
function WhereToBuy() {
  ...
  const stores = [
    ...
    { name: 'Quetta', address: 'Quetta', latitude: 30.1798, longitude: 66.975 },
  ];
  ...
  const showPosition = (position) => {
    ...
    stores.forEach((store) => {
      ...
      if (distance < 150) {
        // Check if distance is less than 150 km
    ...
    <MaxWidthWrapper className="md:mt-28 mt-24">
      ...
      >
          ...
          <div className="flex flex-row-reverse">
            <div className=" lg:w-[85%] w-full lg:items-center items-start  flex lg:justify-center justify-start text-start flex-col lg:my-10 my-6 mx-auto">
              ...
              <div
                ...
                className="w-full flex items-center  justify-start gap-1  cursor-pointer  py-2"
              >
                <IoLocationSharp
                  color="#EE2A2"
                  size={20}
              ...
              <div className="sm:text-base text-sm font-medium font-albert mt-2">
                Explore our extensive collection of top-quality stones in
                person! Enter your location now to uncover the nearest
                Sharifstone warehouse, where our top-quality stones await your
        ...
        <div className="lg:w-1/2 w-full flex flex-col items-center ">
          ...
          {notFound &&
            nearestStore.name !== 'Tampa' &&
            nearestStore.name !== 'Orlando' && (
              <iframe
                title="Google Map"
                width="100%"
                className=" sm:h-[600px] h-[400px]"
          ...
          {!notFound && !showNearestStore && !showLiveLocation && (
            <iframe
              title="Google Map"
              width="100%"
              className=" sm:h-[600px] h-[400px]"
