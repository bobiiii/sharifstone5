    ...
    <MaxWidthWrapper className="md:mt-20 mt-11">
      <div className="home-aboutconatiner w-full">
        <div className="home-aboutinnercontainer">
          <Heading className="text-center">GET TO KNOW US</Heading>
            ...
            <div className=" w1/2 flex flex-col xl:gap-6 gap-3">
              <span>
                <p className=" sm:text-base text-sm">
                  ...
                  States specializing in premium stones, including marble,
                  granite, and quartz. We take pride in delivering top-quality
                  stones at unbeatable prices. Our extensive selection and
                  unwavering commitment to surpassing customer expectations set
                  us apart in the industry.
                </p>
              </span>
              <span className="sm:text-base text-sm">
                <p className="sm:text-base text-sm">
                  At Sharifstone, our dedicated team is here to guide you
                  through the entire process, offering wide range of stones
                  perfect for residential, commercial, and architectural
                  projects. With our steadfast commitment to professionalism and
                  customer satisfaction, Sharifstone has built strong
                  relationships with clients nationwide.
                </p>
              </span>
              <span>
                <p className="sm:text-base text-sm">
                  Explore the perfect stones for your project and elevate your
                  space with Sharifstone!
                </p>
              </span>
          ...
          <div className=" w-full  lg:hidden flex flex-wrap py-4    items-center justify-center">
            {aboutIdeas.map((v, i) => (
              <div
                key={i}
                className="  flex w-[45%]  justify-center items-center text-center   mx-auto "
              >
                <Link
                  to={v.href}
                ...
                >
                  {i === 0 ? (
                    <Lottie
                      animationData={require('../eye.json')}
                      className="h-5/6 "
                    />
                  ) : i === 1 ? (
                    <Lottie
                      animationData={require('../color.json')}
                      className="h-5/6 "
                    />
                  ) : i === 2 ? (
                    <Lottie
                      animationData={require('../buy.json')}
                      className="h-5/6 "
                    />
                  ) : null}
          ...
          <div className="lg:flex hidden justify-center w-full items-center">
            <div className=" w-full lg:px-10 px-6  justify-center items-center max-w-screen-lg flex  gap-8 py-4 my-6  ">
              {aboutIdeas.map((v, i) => (
                <div
                  key={i}
                  className="  flex w-[100%] flex-grow  h-full  justify-center items-center     "
                >
                  <Link
                    to={v.href}
                  ...
                  >
                    {i === 0 ? (
                      ...
                      <Lottie animationData={require('../color.json')} />
                    ) : i === 2 ? (
                      <Lottie animationData={require('../buy.json')} />
                    ) : null}
