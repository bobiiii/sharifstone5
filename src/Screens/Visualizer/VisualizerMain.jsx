                        ...
                        <div className=" flex  gap-x-4  pb-2">
                            <Button
                                className={`px-6 py-2 2xl:px-8
                                 ${activeTab === 'colors' ? 'bg-red-600 text-white ' : 'bg-white text-black border border-black'}
                                 `}
                            ...
                            <Button
                                className={`px-6 py-2 2xl:px-8
                                ${activeTab === 'colors' ? 'bg-white text-black border border-black' : ' bg-red-600 text-white '}
                                 `}
                                    ...
                                    {filteredColors?.map((item, i) => {
                                        return (
                                            ...
                                            >
                                                ...
                                                <h3 className="text-start text-sm font-normal font-albert mt-1">{item?.colorName}</h3>
                                            </div>
                                        );
                                    })}
                                    {filteredColors?.map((item, i) => {
                        ...
                        {activeTab === 'colors' ? (
                            ...
                            <>
                                <div className="  flex justify-center items-center flex-col">
                                    ...
                                    />
                                    <h5 className=" text-base font-semibold font-albert ">{ActiveColor?.colorName}</h5>
                                </div>
                                <h4 className='text-base font-albert font-medium px-4'>Select color</h4>
