                        ...
                        return (
                            ...
                            >
                                <div className='w-full   flex flex-grow '>
                                    <img src={`https://drive.google.com/thumbnail?id=${item.cardImage
                                        }&sz=w1000`} alt={item.title} className='w-full rounded-3xl' />
                                </div>
                                    ...
                                    <div className=' flex flex-col gap-3 '>
                                        <div className='flex gap-3 items-center'>
                                            <span className='flex gap-2 items-center justify-center  ' >
                                                <img src={cal} alt='icon' className='w-5 h-5' />
                                                <p className='text-sm text-[#8C89A2]'>
                                                    {item.date.split('T')[0]}
                                                </p>
                                            </span>
                                            <span className='flex gap-2 items-center justify-center  ' >
                                                <img src={eye} alt='icon' className='w-5 h-4' />
                                                <p className='text-sm text-[#8C89A2]'>
                                                    {item.views}
                                                </p>
                                            </span>
