...
function Footer() {
  ...
  return (
    ...
    //   </div>
    // </div>
    // <footer className="relative bg-white w-full h-screen   ">
    //   <img className="absolute right-0 bottom-0" src={BgImage} alt={"alt"} />
    //   <MaxWidthWrapper className='py-16 flex flex-col justify-between gap-16'>
    ...
    //           <span className="py-0">
    //             <p className="font-albert font-normal text-base text-black">2440 Dinneen</p>
    //             <p className="font-albert font-normal text-base text-black">Ave, Orlando, FL</p>
    //             <p className="font-albert font-normal text-base text-black">32804</p>
    //           </span>
    ...
    //           <span className="py-0">
    //             <p className="font-albert font-normal text-base text-black">(407) 286-4677</p>
    //           </span>
    ...
    //           <span className="py-0">
    //             <p className="font-albert font-normal text-base text-black">orlando@sharifston e.com</p>
    //           </span>
    ...
    //           <FaLocationDot className="text-[#EE2A2E] mt-1" size={20} />
    //           <span className="py-0">
    //             <p className="font-albert font-normal text-base text-black">8524 E. Adamo </p>
    //             <p className="font-albert font-normal text-base text-black">Dr. Tampa, FL</p>
    //             <p className="font-albert font-normal text-base text-black">33619</p>
    //           </span>
    //         </li>
    ...
    //         <li className="flex gap-3 ">
    //           <Link to='#' className="font-albert font-normal text-base text-black">About Us</Link>
    //         </li>
    //         <li className="flex gap-3 ">
    //           <Link to='#' className="font-albert font-normal text-base text-black">Contact</Link>
    //         </li>
    //         <li className="flex gap-3 ">
    //           <Link to='#' className="font-albert font-normal text-base text-black">Warranty & Support</Link>
    //         </li>
    //       </ul>
    //       <ul className="flex flex-col gap-6">
