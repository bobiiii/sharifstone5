...
const QuartzDropdown = () => {
  ...
  return (
    <div
      ref={dropdownRef}
      className={`xl:block hidden z-50 bg-white rounded-2xl left-[50%] translate-x-[-50%]    absolute  ${
        location.pathname === '/where-to-buy' ? 'top-5' : 'top-3 '
      }    mx-auto mt-10`}
    >
      <div className="">
                ...
                <div className=" relative  h-[200px] w-[230px] px-2  ">
                  {hover === v.collectionName ? (
                    <div className=" w-[100%] h-[100%]  ">
                      <img
                        src={`https://drive.google.com/thumbnail?id=${v.dropDownImage}&sz=w1000`}
                        className=" w-[100%] h-[100%]  "
                        alt="a"
                      />
                      <p className="text-white  w-[210px] pt-2  font-semibold font-albert text-[17px] text-center absolute top-0 ">
                        {v.collectionName}
                      </p>
                      <img
                    ...
                    <div className=" w-full  h-full py-2">
                      <p className="h-1/5 text-black font-medium text-base text-center text-nowrap truncate px-2">
                        {v.collectionName}
                      </p>
                      <img
